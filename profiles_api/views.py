...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    """Handle managing users feed : creating, reading, updating profile feed items"""
    authentication_classes = (TokenAuthentication,)
    ...
    def perform_create(self, serializer):
        """Override the default perform create to handle the user profile field in a creation of a new item"""
